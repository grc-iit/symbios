...
declare -a policies=("RANDOM_POLICY" "ROUND_ROBIN_POLICY" "HEURISTICS_POLICY") # "RANDOM_POLICY" "ROUND_ROBIN_POLICY" "HEURISTICS_POLICY" "DYNAMIC_PROGRAMMING_POLICY")
declare -a request_sizes=(1 2 4 8 16 32 64 128 246 512 1024 2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152 4194304 8388608 16777216)
